...
import 'package:bookstoreapplication/controller/orders/details_controller.dart';
                            ...
                            children: [
                              ...
                              ...List.generate(
                                  ...
                                  (index) => TableRow(children: [
                                        Text("${controller.data[index].bookName}",
                                            textAlign: TextAlign.center),
                                        Text("${controller.data[index].countbook}", textAlign: TextAlign.center),
                                        Text("${controller.data[index].bookPrice}",
                                            textAlign: TextAlign.center),
                                      ]))
                            ],
                          ),
