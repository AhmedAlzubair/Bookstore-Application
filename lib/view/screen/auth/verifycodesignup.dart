import 'package:bookstoreapplication/controller/auth/verfiycodesignup_controller.dart';
          ...
          builder: (controller) => HandlingDataRequest(
              ...
              widget: Container(
                ...
                child: ListView(children: [
                  ...
                  InkWell(onTap: (){
                    controller.reSend() ; 
                  },child: Center(child: Text("42".tr , style:const TextStyle(color: AppColor.primaryColor , fontSize: 20 ),)),)
                ]),
              ))),
    );
  }
