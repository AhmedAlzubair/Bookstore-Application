import 'package:bookstoreapplication/controller/forgetpassword/verifycode_controller.dart';
      ...
      body: GetBuilder<VerifyCodeControllerImp>(
          builder: (controller) => HandlingDataRequest(
            ...
            child: ListView(children: [
              ...
              CustomTextBodyAuth(text: controller.email.toString()),
