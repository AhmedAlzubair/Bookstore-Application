...
static const String server="https:///book_php";
//========================== Image ============================
  static const String imageststatic = "../angle_delivery_php";
  static const String imagestcatss = "$server/upload/categories";
  static const String imagestPublisher = "$server/upload/publishers";
  static const String imagestProduct = "$server/upload/books";
// =============================================================
//
...
// ================================= ForgetPassword ========================== //
  ...
  static const String checkEmail = "$server/forgetpassword/checemail.php";
  static const String resetPassword ="$server/forgetpassword/resetpassword.php";
      
  static const String verifycodeforgetpassword ="$server/forgetpassword/verifycodepass.php";
...
// Home
  ...
  static const String catogreies = "$server/Catogreies/view.php";
   static const String searchCat = "$server/Catogreies/search.php";
// items
  static const String items = "$server/item/items.php";
  // static const String itemsview = "$server/item/itemview.php";
  static const String itemsview2 = "$server/books/view.php";
  static const String itemsview3 = "$server/books/bookview.php";
  static const String searchbook = "$server/books/search.php";
  static const String searchitems = "$server/books/search.php";

  /// officer
  static const String officeritem = "$server/offers.php";
...
//////////////////////Admin
  ...
  static const String viewuser = "$server/admin/auth/viewuser.php";
  static const String edituser = "$server/admin/auth/edit.php";
  static const String deleteuser = "$server/admin/auth/delete.php";
///////////Admin services
...
///////////Admin services
  static const String addpublisher = '$server/admin/publisher/add.php';
  static const String editpublisher = '$server/admin/publisher/edit.php';
  static const String deletepublisher = '$server/admin/publisher/delete.php';
  static const String viewpublisher = '$server/admin/publisher/view.php';
 // static const String viewservicesCat = '$server/admin/services/viewsercat.php';
///////////Admin categories
...
///////////Admin Product
  static const String addproduct = '$server/admin/books/add.php';
  static const String editproduct = '$server/admin/books/edit.php';
  static const String deleteproduct = '$server/admin/books/delete.php';
  static const String viewproduct = '$server/admin/books/view.php';
/////////////////Admin order
